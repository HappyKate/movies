...
const movies =[
        ...
        },
        {
            ...
            year: 2010,
            rating: 8.767,
            image_url: "https://st.yandex.net/images/film/iphone360_447301.jpg",
        ...
        },
        {
            ...
            genres: ["мюзикл", "драма", "приключения"]
        },
        {
            id: 389,
            localized_name: "Леон",
        ...
        },
        {
            ...
            genres: ["фэнтези", "боевик", "триллер"]
        },
        {
            id: 409880,
            localized_name: "Нереальный блокбастер",
            name: "Disaster Movie",
            year: 2008,
            rating: 2.563,
            image_url: "https://st.kp.yandex.net/images/film_iphone/iphone360_409880.jpg",
            description: "Фильм о комических злоключениях группы смешных и привлекательных молодых людей. За одну судьбоносную ночь, во время которой им приходится преодолеть и пережить всевозможные катастрофы природного и стихийного происхождения: астероиды, смерчи, землетрясения, в общем, все, что обрушивается на город и оказывается у них на пути, они должны раскрыть череду тайн, чтобы спасти мир от тотального разрушения.",
            genres: ["комедия"]
        },
        {
            id: 841340,
            localized_name: "Мы не можем жить без космоса",
